...
class WorkflowEngine {
    ...
    buildDeployTemplate() {
        return this.defineTemplate('deploy', [
            { name: 'install', description: 'Install dependencies', requiredTools: [], critical: true },
            { name: 'build', description: 'Build the project', requiredTools: [], critical: true },
            { name: 'test', description: 'Run tests', requiredTools: [], critical: false, retryCount: 1 },
            { name: 'deploy', description: 'Deploy to production', requiredTools: [], critical: true },
